...
var obj = [];
           ...
           */
					  ...
					  $.ajax({
						  ...
						  success: function (data2) {
							  //console.log("daaata", data2);
							  							  //skin2 = data2.split(",").map(String);
							  //console.log("222", skin2);
							  
							  
							  //if(skins2.includes(skin2) == false){
							  //skins2.push(skin2);
							  							  										skins2.push(data2);
           ...
           */
				...
				window.setInterval(function () {
								...
								for (let step = 0;  step < skinsIZR.length; step++) {
	
							madeskin = "'";
							
							stringc = madeskin.concat(skinsIZR[step]);
							stringcd = stringc.concat(madeskin);
							
	console.log("thing", stringcd);
										
										
							object = this.third.load.gltf(stringcd)
