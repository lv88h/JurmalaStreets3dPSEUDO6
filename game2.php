...
var obj = [];
              ...
              window.setInterval(function () {
                  vertibasx = obj.slice(0, 1);
                  vertibasy = obj.slice(1, 2);
                  vertibasz = obj.slice(2, 3);
                  ...
                  function myFunction(value, index, array) {
                     ...
                     vertibasx = array.slice(0, 1);
                     vertibasy = array.slice(1, 2);
                     vertibasz = array.slice(2, 3);
...
//console.log("3shitais?", verz);
					...
					//} else {
					              window.setInterval(function () {
															console.log("parvieto", man.position);
									            man.position.set(754.2014, 10, -205.63472)
